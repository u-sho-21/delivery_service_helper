class StoreOrderInfo < ApplicationRecord
  ...
  def delivery_reception_edit
    ...
    self.delivery_reception_time_2_first = self.delivery_reception_time_2[/(.*)(?=~)/]
    self.delivery_reception_time_2_finish = self.delivery_reception_time_2[/(?<=~)(.*)/]
    self.delivery_reception_time_3_first = self.delivery_reception_time_3[/(.*)(?=~)/]
    self.delivery_reception_time_3_finish = self.delivery_reception_time_3[/(?<=~)(.*)/]
    self.delivery_reception_time_4_first = self.delivery_reception_time_4[/(.*)(?=~)/]
    self.delivery_reception_time_4_finish = self.delivery_reception_time_4[/(?<=~)(.*)/]
    self.delivery_reception_time_5_first = self.delivery_reception_time_5[/(.*)(?=~)/]
    self.delivery_reception_time_5_finish = self.delivery_reception_time_5[/(?<=~)(.*)/]
    self.delivery_reception_time_6_first = self.delivery_reception_time_6[/(.*)(?=~)/]
    self.delivery_reception_time_6_finish = self.delivery_reception_time_6[/(?<=~)(.*)/]
    self.delivery_reception_time_7_first = self.delivery_reception_time_7[/(.*)(?=~)/]
    self.delivery_reception_time_7_finish = self.delivery_reception_time_7[/(?<=~)(.*)/]
  end
